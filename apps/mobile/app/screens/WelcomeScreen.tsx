...
type WelcomeScreenProps = Partial<AppStackScreenProps<"Welcome">> // @demo remove-current-line
...
export const WelcomeScreen: FC<WelcomeScreenProps> = function WelcomeScreen(
  ...
  const navigationFromHook = useNavigation<AppStackScreenProps<"Welcome">["navigation"]>()
  // @demo remove-block-start
  const navigation = _props.navigation ?? navigationFromHook
